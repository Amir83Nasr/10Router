...
const SUBMIT_URL = IMG_CFG.baseUrl || "https://api.nanobananaapi.ai/api/v1/nanobanana/generate";
const POLL_BASE = IMG_CFG.pollUrl || "https://api.nanobananaapi.ai/api/v1/nanobanana/record-info";
