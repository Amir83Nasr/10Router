      ...
      <div className="relative mx-auto flex flex-1 h-full min-h-0 w-full max-w-4xl flex-col">
                  ...
                  {providerGroups.map((group) => (
                    ...
                    >
                      <div className="flex items-center justify-between px-2 py-2">
                        ...
                        <Badge>{group.models.length}</Badge>
                      </div>
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-start justify-between gap-3">
                                ...
                                {isActive ? (
                                  <Icon name="check_circle" className="text-[18px] text-blue-300" />
                                ) : null}
                              </div>
                            </button>
                          );
        ...
        {historyOpen ? (
          ...
          >
            ...
            <div className="max-h-[48vh] space-y-2 overflow-y-auto p-1">
            ...
            <div className="mx-auto w-full max-w-3xl px-4 pb-2">
              <div className="rounded-[26px] bg-[#2f2f2f] px-3 pt-3 pb-2 shadow-[0_0_15px_rgba(0,0,0,0.10)] ring-1 ring-white/5">
                <textarea
                  ...
                  rows={1}
                  className="w-full resize-none bg-transparent px-2 text-[15px] leading-6 text-white outline-none placeholder:text-white/40 max-h-[25vh] overflow-y-auto"
                />
