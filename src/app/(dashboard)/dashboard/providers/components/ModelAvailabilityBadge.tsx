          ...
          <div className="px-4 py-3 max-h-60 overflow-y-auto">
            {isHealthy ? (
              ...
              <div className="flex flex-col gap-2.5">
                {Object.entries(byProvider).map(([provider, provModels]: [string, any]) => (
                  <div key={provider}>
                    <p className="text-xs font-semibold text-foreground mb-1.5 capitalize">
                      {provider}
                    </p>
                      ...
                      {provModels.map((m: any) => {
                        ...
                        return (
                          <div
                            ...
                            className="flex items-center justify-between px-2.5 py-1.5 rounded-lg bg-card/30"
                          >
