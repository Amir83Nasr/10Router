...
/**
 * Extract tokens via node:sqlite (built-in, no native binding).
 * This is the preferred strategy — no external CLI required.
 */
async function extractTokensViaNodeSqlite(dbPath) {
  // node:sqlite (built-in, no native binding) — better-sqlite3 crashes
  // workers on Node >= 24 and its binding may be absent.
