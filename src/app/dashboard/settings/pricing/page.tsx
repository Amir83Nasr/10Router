      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="p-4">
          <CardContent className="px-0 py-0">
            <div className="text-muted-foreground text-sm uppercase font-semibold">
              Total Models
            </div>
        ...
        <Card className="p-4">
          <CardContent className="px-0 py-0">
            <div className="text-muted-foreground text-sm uppercase font-semibold">Providers</div>
            <div className="text-2xl font-bold mt-1">{loading ? "..." : getProviders().length}</div>
          </CardContent>
        </Card>
        <Card className="p-4">
          <CardContent className="px-0 py-0">
            <div className="text-muted-foreground text-sm uppercase font-semibold">Status</div>
      ...
      <Card className="p-6">
        <CardContent className="px-0 py-0">
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>
              <strong>Cost Calculation:</strong> Costs are calculated based on token usage and
              pricing rates. Each request&apos;s cost is determined by: (input_tokens × input_rate)
