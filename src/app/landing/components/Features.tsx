...
const FEATURES = [
  ...
  },
  {
    icon: "terminal",
    title: "CLI Support",
    desc: "Works with Claude Code, Codex, Cursor, and more.",
    colors: {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {FEATURES.map((feature) => (
            <div
              key={feature.title}
              className={`p-6 rounded-xl bg-[#122019] border border-[#1f2f26] ${feature.colors.border} ${feature.colors.bg} transition-all duration-300 group`}
            >
              <div
              ...
              >
                <Icon name={feature.icon} className="" />
              </div>
              <h3
