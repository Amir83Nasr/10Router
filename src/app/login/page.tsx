...
export default function LoginPage() {
  ...
  if (hasPassword === null) {
    return (
      <div className="dashboard-grid-bg min-h-screen flex items-center justify-center bg-background p-4">
  ...
  return (
    <div className="dashboard-grid-bg min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
          ...
          <CardContent>
            {mustChange ? (
              ...
              <div className="flex flex-col gap-4">
                {samlAvailable && (
                  <Button type="button" className="w-full" onClick={handleSamlLogin}>
                    {samlLoginLabel}
                  </Button>
                )}
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      {resetHint && (
                        <p className="text-xs text-muted-foreground">
                          ...
                          <code className="bg-sidebar px-1 rounded">10router</code> CLI on the host
