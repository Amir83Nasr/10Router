...
export default function OAuthModal({
  ...
  const [ideStatus, setIdeStatus] = useState<any>(null);
  ...
  const startOAuthFlowRef = useRef<any>(null);
  ...
  const startPolling = useCallback(
    async (deviceCode: any, codeVerifier: any, interval: any, extraData: any, deadlineMs: any) => {
  ...
  const startProxyFlow = useCallback(
    async (providerId: any) => {
      ...
      const regBody: any = { state: authData.state };
  ...
  const startOAuthFlow = async () => {
    ...
    try {
      ...
      if (deviceCodeProviders.includes(provider)) {
        ...
        // Pass extraData for Qoder (contains _qoderMachineId / _qoderNonce — needed so mapTokens
            ...
            <>
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex-1 rounded-lg border px-3 py-2 text-sm transition-colors ${authMode === "browser" ? "border-primary bg-primary/10 text-primary" : "border-border text-muted-foreground hover:text-primary"}`}
                >
                ...
                <button
                  ...
                  className={`flex-1 rounded-lg border px-3 py-2 text-sm transition-colors ${authMode === "paste-token" ? "border-primary bg-primary/10 text-primary" : "border-border text-muted-foreground hover:text-primary"}`}
                >
                  🔑 Paste token
                </button>
              </div>
                  ...
                  {step === "input" && (
                    <div className="space-y-3">
                      <p className="text-sm text-muted-foreground">
                        Popup was blocked. After authorizing in the browser, paste the full callback
                        URL here:
                      </p>
                      <Input
                        value={callbackUrl}
              ...
              {authMode === "paste-token" && (
                <div className="space-y-3">
                  ...
                  <Input
                    ...
                    className="font-mono text-xs"
                  />
                  <Button onClick={handleManualSubmit} className="w-full" disabled={!pasteToken}>
                    Connect
                  </Button>
                </div>
              )}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      <Icon name={copied === "auth_url" ? "check" : "content_copy"} />
                      Copy
                    </Button>
                  </div>
                </div>
            ...
            <div className="text-center py-4">
              ...
              <div className="bg-sidebar p-4 rounded-lg mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <Icon name={copied === "login_url" ? "check" : "content_copy"} />
                  </Button>
                  <Button
                    size="sm"
                    variant="ghost"
              ...
              <div className="bg-primary/10 p-4 rounded-lg">
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  >
                    <Icon name={copied === "user_code" ? "check" : "content_copy"} />
                  </Button>
                </div>
              </div>
            </div>
