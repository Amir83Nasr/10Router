...
export default function RequestLogger() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Card className="overflow-hidden bg-black/5 dark:bg-black/20 p-6">
        <CardContent>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-3 py-1.5 border-r border-border">
                          <span className="px-1.5 py-0.5 rounded bg-muted border border-border text-[10px] uppercase font-bold">
                            {parts[2]}
                          </span>
                        </td>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <td className="px-3 py-1.5 border-r border-border truncate max-w-[150px]">
                              {parts[3]}
                            </td>
                          </TooltipTrigger>
                          <TooltipContent>{parts[3]}</TooltipContent>
                        </Tooltip>
                        <td className="px-3 py-1.5 border-r border-border text-right text-primary">
                          {parts[4]}
                        </td>
                        <td className="px-3 py-1.5 border-r border-border text-right text-emerald-600">
                          {parts[5]}
                        </td>
                        <td
