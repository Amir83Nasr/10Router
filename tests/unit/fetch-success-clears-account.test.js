...
// jina-reader removed from providers/registry (scaffolding refresh) but the
// fetch handler + core still support it. Stub the provider entry here so this
// test exercises the account-state logic, not the provider catalog.
vi.mock("@/shared/constants/providers.js", () => ({
  AI_PROVIDERS: {
    "jina-reader": { id: "jina-reader", fetchConfig: { baseUrl: "https://localhost/fetch" } },
  },
