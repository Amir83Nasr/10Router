...
// naming (gemini-3.8-flash-tiered + thinkingLevel → gemini-3.8-flash-{tier})
...
describe("Gemini 3.8 tiered model extraction", () => {
  it.each(["high", "medium", "low"])(
    ...
    (tier) => {
      ...
      expect(
        extractModel("/v1internal/models/gemini-3.8-flash-tiered:streamGenerateContent", body),
...
describe("Gemini 3.8 catalog and pricing", () => {
